...
// =============================================
// DIY卡丁车固件 v17.03 功能配置
// =============================================

  // ### 驾驶模式配置 ###
  // BBCAR_MODE: 卡丁车模式 (默认)
  // BBCAR_MODE_STEER: 轿车模式 - 摇杆左右为刹车，倒挡按钮切换前进后退
  // BBCAR_MODE_RC: 遥控模式 - 支持差速转向，原地转弯
  // BBCAR_MODE_SPIN: 原地掉头模式 - 短按遥控器关机键切换
  #define BBCAR_DRIVE_MODE BBCAR_MODE
  
  // ### 遥控器+踏板双控系统 ###
  // 启用双控系统，允许ADC(踏板)和UART(遥控器)同时输入，互不干扰
  #define DUAL_CONTROL_ENABLE
  
  // ### 定速巡航配置 ###
  // 启用定速巡航功能 (需要遥控器连接)
  #define CRUISE_CONTROL_ENABLE
  #define CRUISE_MIN_SPEED 200        // 最小巡航速度
  #define CRUISE_MAX_SPEED 800        // 最大巡航速度
  
  // ### 智能空挡配置 ###
  // 启用智能空挡功能 - 停稳松踏板自动进入空挡
  #define SMART_NEUTRAL_ENABLE
  #define NEUTRAL_STOPPED_THRESHOLD 10  // 停止检测阈值 (rpm)
  #define NEUTRAL_TIMEOUT_MS 2000        // 进入空挡等待时间 (ms)
  
  // ### 电子手刹配置 ###
  // 启用电子手刹功能
  #define ELECTRONIC_PARKING_BRAKE_ENABLE
  #define BRAKE_LOCK_THRESHOLD 20       // 手刹锁定速度阈值 (rpm)
  
  // ### 自动相序校准配置 ###
  // 启用霍尔线序自动校准功能
  #define AUTO_HALL_CALIBRATION_ENABLE
  #define HALL_CALIBRATION_SPEED 200    // 校准转速
  #define HALL_CALIBRATION_TIMEOUT 5000 // 校准超时时间 (ms)
  
  // ### 驾驶体验优化配置 ###
  // 自动减速优化
  #define AUTO_DECEL_ENABLE
  #define AUTO_DECEL_COEF 0            // 自动减速系数 (0-50, 默认0)
  
  // 五档增压优化
  #define BOOST_ENABLE
  #define BOOST_THRESHOLD_1 0.2        // 各档位增压阈值
  #define BOOST_THRESHOLD_2 0.4
  #define BOOST_THRESHOLD_3 0.6
  #define BOOST_THRESHOLD_4 0.8
  #define BOOST_MAX_CURRENT 48          // 最大电流设置
  
  // 踏板换挡功能 (双踏板同时踩下开机进入不同档位)
  #define PEDAL_SHIFT_ENABLE
  // 换挡模式由开机时踏板状态决定:
  // 双踏板同时踩下开机 → 4档
  // 踩油门开机 → 3档
  // 不踩踏板开机 → 2档
  ...
  // ### 提示音配置 ###
  #define BEEP_UART_CONTROL 1          // 遥控器连接成功提示音
  #define BEEP_MODE_SWITCH 2            // 切换驾驶模式提示音
  #define BEEP_CALIBRATION_START 4      // 开始自动校准提示音
  #define BEEP_CALIBRATION_DONE 5       // 校准完成提示音
  #define BEEP_GEAR_SHIFT 1             // 换档提示音
  #define BEEP_HAND_BRAKE 1             // 手刹提示音
  #define BEEP_CRUISE_ON 1              // 定速巡航开启提示音
  #define BEEP_CRUISE_OFF 2             // 定速巡航关闭提示音
  #define BEEP_REVERSE 1                 // 倒挡提示音
  #define BEEP_HEADLIGHT 1              // 大灯提示音
  
  // ### 一线通仪表配置 ###
  // 一线通(Yixiantong)仪表通信协议支持
  // 通过UART输出车辆状态信息到电瓶车仪表
  #define YXT_DISPLAY_ENABLE
  #define YXT_USART USART3              // 使用USART3连接一线通仪表
  #define YXT_BAUDRATE 9600             // 一线通常用波特率9600
  #define YXT_UPDATE_INTERVAL 200       // 仪表更新间隔(ms)
  
  // 一线通仪表显示内容配置
  #define YXT_SHOW_SPEED      1         // 显示速度
  #define YXT_SHOW_VOLTAGE    1         // 显示电压
  #define YXT_SHOW_CURRENT    1         // 显示电流
  #define YXT_SHOW_TEMP       1         // 显示温度
  #define YXT_SHOW_GEAR       1         // 显示档位
  #define YXT_SHOW_ERROR      1         // 显示故障码
  ...
  // 手刹开启: 刹车灯点亮
  // 霍尔故障: 电机故障灯点亮
  #define YXT_FAULT_THROTTLE  0x01      // 转把故障灯
  #define YXT_FAULT_CTRL      0x02      // 控制器故障灯
  #define YXT_FAULT_BRAKE     0x04      // 刹车灯
  #define YXT_FAULT_MOTOR     0x08      // 电机故障灯
